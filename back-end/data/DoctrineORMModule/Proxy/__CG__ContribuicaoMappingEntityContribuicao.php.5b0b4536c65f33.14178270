...
namespace DoctrineORMModule\Proxy\__CG__\Contribuicao\Mapping\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Contribuicao extends \Contribuicao\Mapping\Entity\Contribuicao implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['nome' => NULL, 'tipo' => NULL, 'ativo' => NULL];
    ...
    {
        unset($this->nome, $this->tipo, $this->ativo);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'nome', 'tipo', 'ativo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Contribuicao $proxy) {
